...
const directory = resolve("src/apis/notion");
...
assert.equal(Object.keys(lock.apis).length, 49);
assert.equal(Object.keys(lock.components.schemas).length, 523);
...
console.log("Generated-source gate passed: " + Object.keys(expected).length + " deterministic files and 13 explicit Controllers.");
